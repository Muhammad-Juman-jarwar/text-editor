...
export function LayoutElement({ element, onUpdate, onDelete, onClose }: LayoutElementProps) {
  ...
  const updateColumns = (newColumnCount: number) => {
    ...
    const newColumns = Array.from({ length: newColumnCount }).map((_, index) => ({
      id: `col-${index}`,
  ...
  return (
    <div className="element-container" style={{ width: "100%", margin: "16px 0" }}>
      <div
        ...
        style={{
          ...
          border: `${element.settings.borderWidth || 1}px solid ${element.settings.borderColor || "#e5e7eb"}`,
      ...
      >
        ...
        {/* Columns */}
        {Array.from({ length: element.settings.columns || 2 }).map((_, index) => {
          ...
          return (
            ...
            >
              ...
              <div
                ...
                onBlur={(e) => handleColumnContentChange(index, e.target.innerHTML)}
                onFocus={(e) => {
                  if (e.target.textContent?.trim() === `Column ${index + 1}` || e.target.textContent?.trim() === "") {
                    e.target.innerHTML = ""
                  }
                }}
                dangerouslySetInnerHTML={{
                  __html: columnContent || `<p style="color: #9ca3af; font-style: italic;">Click to add content...</p>`,
                }}
              />
            </div>
          )
...
export function LayoutSettingsPanel({ selectedElement, onUpdate, onClose }: LayoutSettingsPanelProps) {
  ...
  const updateSetting = (key: string, value: any) => {
    ...
    const layoutElement = selectedElement.querySelector(".layout-element") as HTMLElement
    if (layoutElement) {
  ...
  return (
    <div className="w-80 bg-background border-l border-border h-full overflow-y-auto">
      <div className="p-4 border-b border-border">
        ...
        <p className="text-sm text-muted-foreground mt-1">Multi-column layout element</p>
      </div>
      ...
      <div className="p-4 space-y-6">
          ...
          <TabsContent value="layout" className="space-y-4">
            <div>
              ...
              <Select
                ...
                onValueChange={(value) => updateSetting("columns", Number.parseInt(value))}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div>
              ...
              <Slider
                ...
                className="mt-2"
              />
              <div className="text-xs text-muted-foreground mt-1">{settings.columnGap || 16}px</div>
            </div>
            ...
            <div>
              ...
              <Slider
                ...
                className="mt-2"
              />
              <div className="text-xs text-muted-foreground mt-1">{settings.padding || 16}px</div>
            </div>
            ...
            <div>
              ...
              <Slider
                ...
                className="mt-2"
              />
              <div className="text-xs text-muted-foreground mt-1">{settings.minHeight || 120}px</div>
            </div>
          </TabsContent>
          ...
          <TabsContent value="style" className="space-y-4">
            ...
            <div>
              ...
              <Slider
                ...
                className="mt-2"
              />
              <div className="text-xs text-muted-foreground mt-1">{settings.borderWidth || 1}px</div>
            </div>
            ...
            <div>
              ...
              <Slider
                ...
                className="mt-2"
              />
              <div className="text-xs text-muted-foreground mt-1">{settings.borderRadius || 8}px</div>
            </div>
          </TabsContent>
        </Tabs>
        ...
        <Button variant="destructive" size="sm" onClick={onClose} className="w-full">
